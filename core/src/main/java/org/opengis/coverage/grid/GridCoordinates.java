...
/**
 * <p>Holds the set of grid coordinates that specifies the location of the
 * {@linkplain GridPoint grid point} within the {@linkplain Grid grid}.</p>
 *
 * <p>Annotations removed for inclusion in EDAL, pending acceptance of this class
 * into GeoAPI proper (Jon Blower).</p>
 *
