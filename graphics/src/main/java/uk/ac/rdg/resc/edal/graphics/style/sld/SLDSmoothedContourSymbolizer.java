...
public class SLDSmoothedContourSymbolizer implements SLDSymbolizer {

	private String layerName;
	private Node symbolizerNode;
	private ImageLayer imageLayer;

	public SLDSmoothedContourSymbolizer(String layerName, Node symbolizerNode) throws SLDException {
		try {
	...
	private ImageLayer parseSymbolizer() throws NumberFormatException, XPathExpressionException, SLDException {
		...
		// instantiate a new smoothed contour layer and add it to the image
		SmoothedContourLayer contourLayer = new SmoothedContourLayer(layerName, scale, autoscaleEnabled, numberOfContours, contourLineColour, contourLineWidth, contourLineStyle, labelEnabled);
		if (!(opacity == null)) {
