...
public class LonLatPositionImplTest {
    ...
    public void simpleTest() {
        ...
        assertEquals(TEST_POS.getCoordinateReferenceSystem().getCoordinateSystem().getDimension(),
                2);
    ...
    /**
     * Test creating a LonLatPositionImpl with a longitude outside the range
     * [-180:180]
     */
    @Test
