...
//                "testcollection", "Test Collection", "N:/Data/ostia.nc");
        ...
        File xmlFile = new File(ClassLoader.getSystemResource("xml/se_confidence_interval.xml").getFile());
        File imageFile = new File("N:/xmlOutput/se_confidence_interval.png");
		try {
